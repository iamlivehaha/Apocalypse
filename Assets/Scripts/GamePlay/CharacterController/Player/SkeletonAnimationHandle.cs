...
namespace Assets.Scripts.GamePlay.CharacterController
{
    public class SkeletonAnimationHandle : MonoBehaviour
    {
        ...
        public List<SkeletonAnimationHandle.StateNameToAnimationReference> statesAndAnimations = new List<SkeletonAnimationHandle.StateNameToAnimationReference>();
        public List<SkeletonAnimationHandle.AnimationTransition> transitions = new List<SkeletonAnimationHandle.AnimationTransition>(); // Alternately, an AnimationPair-Animation Dictionary (commented out) can be used for more efficient lookups.
